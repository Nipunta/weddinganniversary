          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="sweeping-light-card bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-card-float">
              <div className="text-center">
                ...
                <p className="font-bold text-lg mb-1 animate-split-reveal-text bg-gradient-to-r from-purple-700 via-indigo-600 to-blue-700 bg-clip-text text-transparent">December 15, 2024</p>
                <p className="font-bold text-lg mb-1 animate-split-reveal-text bg-gradient-to-r from-emerald-700 via-teal-600 to-cyan-700 bg-clip-text text-transparent">Saturday</p>
                <p className="font-bold flex items-center justify-center space-x-2 animate-split-reveal-text bg-gradient-to-r from-rose-700 via-pink-600 to-purple-700 bg-clip-text text-transparent">
                  <Clock size={16} />
